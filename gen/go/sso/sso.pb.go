...
type RegisterResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UsedId        int64                  `protobuf:"varint,1,opt,name=used_id,json=usedId,proto3" json:"used_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *IsAdminRequest) GetUsedId() int64 {
	if x != nil {
		return x.UsedId
	}
	return 0
...
var file_sso_sso_proto_rawDesc = string([]byte{
	...
	0x64, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x75, 0x73, 0x65, 0x64,
	...
	0x5a, 0x14, 0x64, 0x61, 0x6e, 0x69, 0x6c, 0x75, 0x6b, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31,
	0x3b, 0x73, 0x73, 0x6f, 0x79, 0x31, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
})
